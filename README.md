...
- `assets/matty-island-logo-1024.png` — high-res logo render
- `assets/logo-source-b18.html` — logo working source

Design: navy & gold identity built around the sunset-palm badge logo (B18).
